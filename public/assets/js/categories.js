...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('table',{staticClass:"table"},[_c('tbody',_vm._l((_vm.rows),function(row,index){return _c('tr',[_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(row.name),expression:"row.name"}],attrs:{"type":"text","id":"index"},domProps:{"value":(row.name)},on:{"input":function($event){if($event.target.composing){ return; }row.name=$event.target.value}}})]),_vm._v(" "),_c('td',[_c('button',{staticClass:"glyphicon glyphicon-trash",on:{"click":function($event){_vm.removeElement(index)}}})])])}))]),_vm._v(" "),_c('span',[(_vm.showSaveButton == true)?_c('button',{staticClass:"btn btn-primary",attrs:{"type":"button"},on:{"click":_vm.save}},[_vm._v("Save")]):_vm._e()]),_vm._v(" "),_c('a',{staticClass:"glyphicon glyphicon-plus pull-right green",attrs:{"type":"button"},on:{"click":_vm.addRow}})])}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d9b15694", __vue__options__)
  } else {
    hotAPI.reload("data-v-d9b15694", __vue__options__)
  }
})()}
...
var _AddCategory = require('./AddCategory.vue');
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-468bc1f5", __vue__options__)
  } else {
    hotAPI.reload("data-v-468bc1f5", __vue__options__)
  }
})()}
},{"./AddCategory.vue":9,"vue":7,"vue-hot-reload-api":4,"vue-spinner/dist/vue-spinner.min.js":6}],11:[function(require,module,exports){
'use strict';
...
},{"./Categories.vue":10,"vue":7,"vue-event-bus":3,"vue-resource":5}]},{},[11]);
